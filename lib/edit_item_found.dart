...
class EditDataFound extends StatefulWidget {
  final String? id;
  final String? nama;
  final String? deskripsi;
  
  EditDataFound({this.id, this.nama, this.deskripsi});

  @override
  _EditDataState createState() => _EditDataState();
}

class _EditDataState extends State<EditDataFound> {
  ...
  void editData() async {
    ...
    DocumentReference documentReference =
        FirebaseFirestore.instance.collection('item_found').doc(widget.id);
