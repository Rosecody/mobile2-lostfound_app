...
class AddLost extends StatefulWidget {
  @override
  _TambahDataLostState createState() => _TambahDataLostState();
}

class _TambahDataLostState extends State<AddLost> {
  ...
  void addData() async {
    if (_imageFile != null) {
      ...
      DocumentReference documentReference = FirebaseFirestore.instance.collection('item_lost').doc(idController.text);
